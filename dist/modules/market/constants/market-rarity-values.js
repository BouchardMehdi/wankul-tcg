...
exports.MARKET_RARITY_BASE_VALUES = exports.MARKET_SMOOTHING_HISTORY_LIMIT = exports.MARKET_DAILY_MAX_DOWN_PCT = exports.MARKET_DAILY_MAX_UP_PCT = exports.MARKET_PRICE_SMOOTHING_WEIGHT = exports.MARKET_KEEP_MIN_COPIES = exports.DEFAULT_MARKET_BASE_VALUE = void 0;
exports.normalizeMarketRarity = normalizeMarketRarity;
exports.getRarityEconomicRule = getRarityEconomicRule;
const RARITY_RULES = [
    {
        rarity: 'Terrain',
        baseValue: 3,
...
exports.DEFAULT_MARKET_BASE_VALUE = 15;
exports.MARKET_KEEP_MIN_COPIES = 1;
exports.MARKET_PRICE_SMOOTHING_WEIGHT = 0.65;
exports.MARKET_DAILY_MAX_UP_PCT = 0.08;
exports.MARKET_DAILY_MAX_DOWN_PCT = 0.08;
exports.MARKET_SMOOTHING_HISTORY_LIMIT = 7;
const rarityAliasMap = new Map();
...
function normalizeMarketRarity(rarity) {
    return rarityAliasMap.get(rarity) ?? rarity;
}
function getRarityEconomicRule(rarity) {
    const normalized = normalizeMarketRarity(rarity);
    return (RARITY_RULES.find((rule) => rule.rarity === normalized) ?? {
        rarity: normalized,
        baseValue: exports.DEFAULT_MARKET_BASE_VALUE,
        floorPrice: Math.max(1, Math.floor(exports.DEFAULT_MARKET_BASE_VALUE * 0.7)),
        ceilingPrice: Math.max(2, Math.ceil(exports.DEFAULT_MARKET_BASE_VALUE * 1.8)),
        quickSellRate: 0.45,
        duplicateRewardRate: 0.18,
        duplicateRewardMin: 2,
...
exports.MARKET_RARITY_BASE_VALUES = Object.fromEntries(Array.from(rarityAliasMap.entries()).map(([rarity, canonical]) => [
    rarity,
    getRarityEconomicRule(canonical).baseValue,
]));
//# sourceMappingURL=market-rarity-values.js.map