...
const STEPS: TourStep[] = [
  {
    ...
    body: "Ce mini tuto se lance seulement a la premiere connexion. Il va te guider vers ton premier booster, puis te montrer la collection et le market.",
    bullets: [
      "Tu peux passer le tuto quand tu veux.",
      "Seule action demandee : ouvrir ton premier booster.",
      "Le reste sert juste a te montrer ce qui est possible.",
    ],
    route: "/dashboard",
  ...
  },
  {
    ...
    body: "Choisis le bouton encadre pour lancer ta premiere ouverture. Les displays et l'historique existent aussi, mais on reste simple pour demarrer.",
    bullets: [
      "Un booster ajoute les cartes a ta collection.",
      "Les doublons rapportent des credits.",
      "Les gros hits sont mis en avant pendant l'ouverture.",
    ],
    route: "/booster",
    target: '[data-onboarding="booster-open"]',
    primaryLabel: "En attente du booster",
    helper: "Clique sur le bouton de booster encadre pour continuer.",
    locked: true,
  },
  {
    id: "opening",
    eyebrow: "Etape 2",
    title: "Decouvre l'ouverture.",
    ...
    bullets: [
      ...
      "Le resume affiche les gains, les nouvelles cartes et les hits.",
      "Quand tu es pret, on passe a la collection.",
    ],
    demo: "swipe",
  ...
  },
  {
    ...
    body: "La collection te permet de voir ce que tu possedes, ce qu'il te manque, tes doublons utiles, tes favoris et tes objectifs perso.",
    bullets: [
      "Filtre par saison, rarete, type, artiste ou tag perso.",
    ...
    sections: [
      ...
      { label: "Stats & objectifs", text: "Progression par saison/rarete, cartes manquantes, doublons utiles et objectifs." },
  ...
  },
  {
    id: "market",
    eyebrow: "Etape 4",
    title: "Le market fait vivre l'economie.",
    body: "Le market sert a acheter, vendre, suivre des cartes en watchlist, surveiller les bonnes affaires et recuperer les recompenses de tes ventes.",
    bullets: [
      "Mes ventes suit tes annonces et recompenses.",
      "Recherche et suggestions aident a trouver les bons deals.",
      "Watchlist envoie des alertes quand une carte matche tes criteres.",
    ],
    sections: [
      { label: "Mes ventes", text: "Tes annonces actives, vendues, annulees et les recompenses a recuperer." },
      { label: "Suggestions", text: "Les bonnes affaires detectees par rapport au prix du marche." },
      { label: "Watchlist", text: "Les cartes que tu recherches avec alertes de prix et disponibilite." },
      { label: "Recherche", text: "Tous les filtres pour acheter une carte ou comparer les offres." },
      { label: "Historique", text: "Les ventes recentes pour lire la tendance d'une carte." },
    ],
    route: "/market",
